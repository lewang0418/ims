...
<<<<<<< HEAD:blueprints/clearwater-scripts-plugin-blueprint/scripts/homer.sh
...
=======
>>>>>>> cross-domain:blueprints/clearwater-scripts-plugin-blueprint/scripts/homer-install.sh
